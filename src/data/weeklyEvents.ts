...
export const weeklyEvents: WeeklyEvent[] = [
  ...
  defineEvent({
    ...
    reactionAxis: 'mixed',
    primarySegments: ['youth', 'merchants'],
    tensionSegments: ['civilServants'],
    primaryPoliticalSegments: ['liberal', 'populist'],
    tensionPoliticalSegments: ['conservative', 'nationalist'],
    tensionRationale:
  ...
  defineEvent({
    ...
    affectedSegments: ['youth', 'workers', 'civilServants'],
    reactionAxis: 'mixed',
    primarySegments: ['workers', 'civilServants'],
    tensionSegments: ['youth'],
    primaryPoliticalSegments: ['nationalist', 'conservative'],
    tensionPoliticalSegments: ['liberal', 'populist'],
    tensionRationale:
      'Güvenlik vurgusu düzen yanlısı tabanda güçlenir; genç ve özgürlükçü seçmende sertlik endişesi doğabilir.',
  ...
  defineEvent({
    ...
    primarySegments: ['civilServants', 'retirees'],
    tensionSegments: ['youth'],
    primaryPoliticalSegments: ['nationalist', 'conservative'],
  ...
  defineEvent({
    ...
    primarySegments: ['youth', 'workers'],
    tensionSegments: ['retirees'],
    primaryPoliticalSegments: ['populist', 'nationalist'],
    tensionPoliticalSegments: ['liberal'],
    tensionRationale:
  ...
  defineEvent({
    ...
    tensionPoliticalSegments: ['liberal', 'populist'],
    tensionRationale:
      'Karşı saldırı tabanı harekete geçirir; aşırı sert yanıt merkez seçmende güven kaybettirebilir.',
  ...
  defineEvent({
    ...
    affectedCategory: 'strategyProfessionalization',
    policyTopic: 'transparency',
    affectedSegments: ['civilServants', 'retirees', 'youth'],
    reactionAxis: 'mixed',
    primarySegments: ['civilServants', 'retirees'],
    tensionSegments: [],
    primaryPoliticalSegments: ['socialDemocrat', 'liberal', 'populist'],
